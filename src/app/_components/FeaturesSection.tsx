const features = [
  {
    ...
    description:
      "Acompanhe o consumo de energia de seus dispositivos em tempo real, com dados atualizados a cada segundo.",
  },
  {
    icon: (
      <svg
  ...
  },
  {
    ...
    description:
      "Visualize gráficos e relatórios completos sobre o consumo de energia ao longo do tempo.",
  },
  {
    icon: (
      <svg
    ...
    description:
      "Identifique desperdícios e receba dicas personalizadas para reduzir sua conta de luz.",
  },
];
